...
public class HudSprites {
    ...
    public static final ResourceLocation ARMOR_FULL = BeyondHorizon.resourceGui("sprites/icon/armor_full.png");
    public static final ResourceLocation ARMOR_EMPTY = BeyondHorizon.resourceGui("sprites/icon/armor_empty.png");
    public static final ResourceLocation ARMOR_HALF = BeyondHorizon.resourceGui("sprites/icon/armor_half.png");
