...
public class BHEffectTags {
    ...
    public static final TagKey<MobEffect> SWEET_DREAM_IMMUNE_TO = create("sweet_dream_immune_to");
    public static final TagKey<MobEffect> PACE_IMMUNE_TO = create("pace_immune_to");
    public static final TagKey<MobEffect> UNCURSED_IMMUNE_TO = create("uncursed_immune_to");
