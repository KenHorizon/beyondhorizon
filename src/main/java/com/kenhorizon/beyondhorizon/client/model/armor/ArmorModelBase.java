...
public class ArmorModelBase extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createInnerArmorLayer() {
        return LayerDefinition.create(HumanoidArmorModel.createMesh(INNER_ARMOR_DEFORMATION, 0.0F), 64, 32);
    }
    public static LayerDefinition createOuterArmorLayer() {
        return LayerDefinition.create(HumanoidArmorModel.createMesh(OUTER_ARMOR_DEFORMATION, 0.0F), 64, 32);
    }
    @Override
