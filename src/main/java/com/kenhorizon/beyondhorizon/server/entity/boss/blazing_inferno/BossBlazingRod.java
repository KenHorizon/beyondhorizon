...
public class BossBlazingRod extends ExtendedProjectile {
    public BossBlazingRod(EntityType<? extends Projectile> entityType, Level level) {
        super(entityType, level);
        this.setIgniteAttack(true);
    }

    public BossBlazingRod(EntityType<? extends Projectile> entityType, double x, double y, double z, Level level) {
        this(entityType, level);
        this.setPos(x, y, z);
    }

    public BossBlazingRod(Level level, double x, double y, double z, LivingEntity shooter) {
        this(BHEntity.BLAZING_ROD.get(), level);
        this.setOwner(shooter);
        this.setPos(x, y, z);
    }

    public BossBlazingRod(Level level, LivingEntity shooter) {
