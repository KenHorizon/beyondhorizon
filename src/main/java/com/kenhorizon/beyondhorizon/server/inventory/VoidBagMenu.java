...
public class VoidBagMenu extends AbstractContainerMenu {
    ...
    public VoidBagMenu(int containerId, Inventory inventory, ItemStack voidBagItemStack) {
        super(BHMenu.VOID_BAG_MENU.get(), containerId);
        this.itemStack = voidBagItemStack;
        this.handler = this.itemStack.getCapability(ForgeCapabilities.ITEM_HANDLER).resolve().orElseThrow();
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = SLOTS;  // must be the number of slots you have!
