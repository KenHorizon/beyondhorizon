...
public abstract class SurfaceStructures extends Structure {
    ...
    public SurfaceStructures(StructureSettings settings, Set<Holder<Biome>> allowedBiomes, boolean doCheckHeight, boolean doAvoidWater, boolean doAvoidStructures) {
        super(settings);
    ...
    public SurfaceStructures(StructureSettings settings, Set<Holder<Biome>> allowedBiomes) {
        this(settings, allowedBiomes, true, true, true);
    }

    public SurfaceStructures(StructureSettings settings) {
        super(settings);
    }
