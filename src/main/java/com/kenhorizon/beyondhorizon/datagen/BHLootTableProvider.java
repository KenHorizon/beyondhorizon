...
//            this.addRegister(PYROLLIGER);
        ...
        protected void addRegister(EntityLootDropBuilder builder) {
            this.add(builder.getEntityType(), builder.build());
        }
        ...
        public void generate(BiConsumer<ResourceLocation, LootTable.Builder> output) {
            output.accept(BHLootTables.SEALED_RUNIC_CRYPT_LEFT, LootTable.lootTable()
                    .withPool(LootPool.lootPool().setRolls(this.getRolls(1.0F))
                            ...
                            .add(LootItem.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(20)).apply(setCounts(1, 2)))
                    .withPool(LootPool.lootPool().setRolls(this.getRolls(3.0F))
                            ...
                            .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(20)).apply(setCounts(3, 5))
                            .add(LootItem.lootTableItem(BHItems.ANCIENT_HEAVY_CORE.get()).setWeight(20)).apply(setCounts(1)))
                    .withPool(LootPool.lootPool().setRolls(this.getRolls(3.0F))
                            .add(LootItem.lootTableItem(Items.BREAD).setWeight(20)).apply(setCounts(3, 5))
                            .add(LootItem.lootTableItem(Items.BAKED_POTATO).setWeight(20)).apply(setCounts(3, 5))
                            .add(LootItem.lootTableItem(Items.COOKED_BEEF).setWeight(20)).apply(setCounts(3, 5))
                            .add(LootItem.lootTableItem(Items.CARROT).setWeight(20)).apply(setCounts(3, 5))
                            .add(LootItem.lootTableItem(Items.BEETROOT).setWeight(20)).apply(setCounts(3, 6))
            ));
            ...
            output.accept(BHLootTables.SEALED_RUNIC_CRYPT_MIDDLE, LootTable.lootTable()
                    ...
                    .withPool(LootPool.lootPool().setRolls(this.getRolls(2.0F))
