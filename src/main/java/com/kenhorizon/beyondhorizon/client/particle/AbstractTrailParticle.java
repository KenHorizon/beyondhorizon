...
public abstract class AbstractTrailParticle extends Particle {
    ...
    public AbstractTrailParticle(ClientLevel clientLevel, double x, double y, double z, double xd, double yd, double zd, float r, float g, float b) {
    ...
    public AbstractTrailParticle(ClientLevel clientLevel, double x, double y, double z, double xd, double yd, double zd) {
        this(clientLevel, x, y, z, xd, yd, zd, 1.0F, 1.0F, 1.0F);
    }
