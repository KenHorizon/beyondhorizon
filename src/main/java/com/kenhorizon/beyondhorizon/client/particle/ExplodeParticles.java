...
public class ExplodeParticles extends TextureSheetParticle {
    private SpriteSet sprites;

    protected ExplodeParticles(ClientLevel world, double x, double y, double z, double xSpeed, SpriteSet sprites) {
    ...
    public static class DefaultProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            ExplodeParticles particle = new ExplodeParticles(level, x, y, z, dx, this.sprites);
