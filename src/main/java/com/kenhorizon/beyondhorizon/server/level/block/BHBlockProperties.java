...
import com.kenhorizon.beyondhorizon.server.level.block.the_forge.ForgeTypeStation;
...
public class BHBlockProperties {
    ...
    public static final EnumProperty<ForgeTypeStation> FORGE_TYPE_STATION = EnumProperty.create("forge_type_station", ForgeTypeStation.class);
