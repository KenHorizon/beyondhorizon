...
import com.kenhorizon.beyondhorizon.server.level.block.BasicBlock;
import com.kenhorizon.beyondhorizon.server.level.block.GateBlock;
import com.kenhorizon.beyondhorizon.server.level.block.WaterloggedTransparentBlock;
import com.kenhorizon.beyondhorizon.server.level.block.WorkbenchBlock;
import com.kenhorizon.beyondhorizon.server.level.block.arcane.ArcaneBlock;
import com.kenhorizon.beyondhorizon.server.level.block.arcane.ArcaneBudding;
import com.kenhorizon.beyondhorizon.server.level.block.basin.FireBasinBlock;
import com.kenhorizon.beyondhorizon.server.level.block.basin.WallFireBasinBlock;
import com.kenhorizon.beyondhorizon.server.level.block.fence.LatticeFenceBlock;
import com.kenhorizon.beyondhorizon.server.level.block.redstone_lane.RedstoneLaneTransmitterBlock;
import com.kenhorizon.beyondhorizon.server.level.block.redstone_lane.RedstoneWiredBlock;
import com.kenhorizon.beyondhorizon.server.level.block.spawner.BaseSpawnerBlock;
import com.kenhorizon.beyondhorizon.server.level.block.redstone_lane.RedstoneLaneBlock;
import com.kenhorizon.beyondhorizon.server.level.block.the_forge.ForgeBlock;
