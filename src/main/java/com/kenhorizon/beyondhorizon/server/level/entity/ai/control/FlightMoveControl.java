package com.kenhorizon.beyondhorizon.server.level.entity.ai.control;
...
public class FlightMoveControl extends MoveControl {
    ...
    public FlightMoveControl(Mob bird, float speedGeneral, boolean shouldLookAtTarget, boolean needsYSupport) {
        super(bird);
    ...
    public FlightMoveControl(Mob bird, float speedGeneral, boolean shouldLookAtTarget) {
        this(bird, speedGeneral, shouldLookAtTarget, false);
    }

    public FlightMoveControl(Mob bird, float speedGeneral) {
