...
@OnlyIn(Dist.CLIENT)
public class StunParticles extends AbstractTrailParticle {
    private static final ResourceLocation CENTER_TEXTURE = BeyondHorizon.resource("textures/particle/stun_star.png");
    ...
    public StunParticles(ClientLevel clientLevel, double x, double y, double z, int entityId, float offset) {
    ...
    public void tick() {
        ...
        if (entityId != -1) {
            ...
            if (entity instanceof LivingEntity living && !living.hasEffect(BHEffects.STUN.get())) {
                this.remove();
            }
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            StunParticles particle = new StunParticles(worldIn, x, y, z, (int) xSpeed, (float) ySpeed);
