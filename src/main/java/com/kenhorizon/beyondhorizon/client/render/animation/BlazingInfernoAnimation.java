package com.kenhorizon.beyondhorizon.client.render.animation;
...
public class BlazingInfernoAnimation {
	public static final AnimationDefinition PREPARE_DEATH_RAY = AnimationDefinition.Builder.withLength(3.0F)
		...
		.addAnimation("leftLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.posVec(-2.0F, -5.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("rightLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.posVec(2.0F, -5.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
	...
	public static final AnimationDefinition DEATH_RAY = AnimationDefinition.Builder.withLength(5.0F)
		...
		.addAnimation("leftLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(4.55F, KeyframeAnimations.posVec(-2.0F, -5.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(5.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("rightLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(2.0F, -5.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition SECOND_PHASE = AnimationDefinition.Builder.withLength(10.0F)
		...
		.addAnimation("leftLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(8.4F, KeyframeAnimations.posVec(0.0F, -4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(9.05F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("rightLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.05F, KeyframeAnimations.posVec(0.0F, -4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(8.45F, KeyframeAnimations.posVec(0.0F, -4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(9.05F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();
	...
	public static final AnimationDefinition DEATH = AnimationDefinition.Builder.withLength(10.0F)
		...
		.addAnimation("leftLowerArmor", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			...
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(3.54F, -3.5333F, 44.8908F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("leftLowerArmor", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, -25.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("rightLowerArmor", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.6F, KeyframeAnimations.degreeVec(-22.5F, 0.0F, -33.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.65F, KeyframeAnimations.degreeVec(-2.1875F, 0.0F, -35.75F), AnimationChannel.Interpolations.LINEAR),
