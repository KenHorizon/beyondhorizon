package com.kenhorizon.beyondhorizon.server.level.entity.projectiles;
...
public class MagicBolt extends ExtendedProjectile {
    public MagicBolt(EntityType<? extends Projectile> entityType, Level level) {
        super(entityType, level);
        this.setNoPhysics(true);
    }

    public MagicBolt(EntityType<? extends Projectile> entityType, double x, double y, double z, Level level) {
    ...
    public MagicBolt(Level level, double x, double y, double z, LivingEntity shooter) {
        this(BHEntity.MAGIC_BOLT.get(), level);
