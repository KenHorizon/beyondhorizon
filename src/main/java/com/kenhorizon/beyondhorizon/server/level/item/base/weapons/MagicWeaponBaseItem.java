package com.kenhorizon.beyondhorizon.server.level.item.base.weapons;
...
import com.kenhorizon.beyondhorizon.server.level.item.base.SkillBaseItems;
import com.kenhorizon.beyondhorizon.server.level.item.classify.IArmPose;
import com.kenhorizon.beyondhorizon.server.level.item.classify.ICustomHitSound;
import com.kenhorizon.beyondhorizon.server.level.item.classify.ICustomSweepParticle;
...
public class MagicWeaponBaseItem extends BasicItem implements ISkillItems, IReloadable, ILeftClick, ICustomSweepParticle, ICustomHitSound, IArmPose {
    private final float abilityPower;
    public final MagicWeaponMaterials materials;
    ...
    public MagicWeaponBaseItem(MagicWeaponMaterials materials, float abilityPower, Properties properties, SkillBuilder skillbuilder) {
    ...
    private void setupDefault() {
        ...
        mapBuilder.put(BHAttributes.ABILITY_POWER.get(), new AttributeModifier(BASE_ATTACK_DAMAGE_UUID, "Weapon Modifier", (double) this.abilityPower, AttributeModifier.Operation.ADDITION));
